...
pub const Instruction = struct {
    pub const Duration = InstructionDuration;
    pub const Opcode = InstructionOpcode;
    pub const AddressingMode = InstructionAddressingMode;
    ...
    pub fn write(self: Self, writer: anytype, op1: ?u8, op2: ?u8) !void {
...
const InstructionAddressingMode = enum {
    Implicit,
    Accumulator,
    Immediate,
    ZeroPage,
...
test "ADC Zero Page" {
    ...
    const expected = Instruction{
        .opcode = Instruction.Opcode.ADC,
        .mode = Instruction.AddressingMode.ZeroPage,
        .size = 2,
...
test "ADC Zero Page X Indexed" {
    ...
    const expected = Instruction{
        .opcode = Instruction.Opcode.ADC,
        .mode = Instruction.AddressingMode.ZeroPage_XIndexed,
        .size = 2,
...
test "ADC Absolute X Indexed" {
    ...
    const expected = Instruction{
        .opcode = Instruction.Opcode.ADC,
        .mode = Instruction.AddressingMode.Absolute_XIndexed,
        .size = 3,
...
test "ADC Absolute Y Indexed" {
    ...
    const expected = Instruction{
        .opcode = Instruction.Opcode.ADC,
        .mode = Instruction.AddressingMode.Absolute_YIndexed,
        .size = 3,
        .duration = Instruction.Duration.pageAware(4),
    };
    const actual = Instruction.decode(opcode);
...
test "ADC X Indexed Indirect" {
    ...
    const expected = Instruction{
        .opcode = Instruction.Opcode.ADC,
        .mode = Instruction.AddressingMode.XIndexed_Indirect,
        .size = 2,
...
test "ADC Indirect Y Indexed" {
    ...
    const expected = Instruction{
        .opcode = Instruction.Opcode.ADC,
        .mode = Instruction.AddressingMode.Indirect_YIndexed,
        .size = 2,
...
test "CLC" {
    ...
    const expected = Instruction{
        .opcode = Instruction.Opcode.CLC,
        .mode = Instruction.AddressingMode.Implicit,
        .size = 1,
        .duration = Instruction.Duration.exactly(2),
    };
    const actual = Instruction.decode(opcode);
...
test "LDX Zero Page Y Indexed" {
    ...
    const expected = Instruction{
        .opcode = Instruction.Opcode.LDX,
        .mode = Instruction.AddressingMode.ZeroPage_YIndexed,
        .size = 2,
        .duration = Instruction.Duration.exactly(4),
    };
    const actual = Instruction.decode(opcode);
